    ...
    <div className="container p-4 mx-auto mb-4">
      ...
      <div className="flex flex-col items-center justify-center gap-8 lg:flex-row">
        ...
        <div className="text-left lg:w-2/3">
          <h3 className="text-2xl font-bold text-blue-700">Boosting Social Media Presence</h3>
          <p className="mt-2 text-gray-700 text-black">
          ...
          <div className="flex justify-between mt-4">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                ...
                <p className="text-black font-normal">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
