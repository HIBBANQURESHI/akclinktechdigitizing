    ...
    >
      ...
      <div className="relative z-10 max-w-md md:ml-24 text-center md:max-w-lg md:text-left">
        ...
        <div className="flex flex-col space-y-4 md:flex-row md:space-x-4 md:space-y-0">
          ...
          <button 
            onClick={toggleModal} 
            className="inline-block w-full px-4 py-2 text-sm font-semibold text-black bg-yellow-400 rounded-lg hover:bg-transparent hover:border-2 hover:border-yellow-500 hover:text-yellow-500 md:w-auto md:px-6 md:py-3 md:text-lg"
          >
            {primaryButtonText}
          </button>
