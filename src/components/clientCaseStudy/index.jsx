...
const ClientCaseStudy = ({ title, imageUrl, description, stats }) => {
  return (
    <div className="container p-4 mx-auto mb-4 bg-white">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-black">Client Case Studies</h2>
        <div className="w-20 h-1 mx-auto my-4 bg-blue-700"></div>
      </div>
