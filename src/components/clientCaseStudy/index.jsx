  ...
  return (
    <div className="container p-4 mx-auto mb-4 bg-white">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-blue-950">Client Case Studies</h2>
      ...
      <div className="flex flex-col items-center justify-center gap-8 lg:flex-row">
        ...
        <div className="text-left lg:w-2/3">
          <h3 className="text-2xl font-bold text-blue-950">Transforming Online Presence</h3>
          ...
          <div className="flex justify-between mt-4">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                <h4 className="text-xl font-bold text-blue-950">{stat.value}</h4>
