...
import image1 from "../../../assets/web-content/feature/img-1.webp"
import image2 from "../../../assets/web-content/feature/img-2.webp"
import image3 from "../../../assets/web-content/feature/img-3.webp"
import image4 from "../../../assets/web-content/feature/img-4.webp"
import image5 from "../../../assets/web-content/feature/img-5.webp"
...
const FeatureSection = () => {
  ...
  const tabs = {
    inventory: {
      ...
      image: image1, // Replace with correct image path
    },
    visuals: {
      ...
      image: image2, // Replace with correct image path
    },
    animation: {
      ...
      image: image3, // Replace with correct image path
    },
    cart: {
      title: "Shopping Cart",
      ...
      image: image4, // Replace with correct image path
    },
    search: {
      title: "Search Bar",
      ...
      image: image5, // Replace with correct image path
    },
  };

  return (
    <section className="container flex flex-col items-start justify-between p-6 mx-auto md:flex-row">
      {/* Left Sidebar - Tabs */}
      <div className="space-y-4 md:w-1/4">
        <div
          onClick={() => setActiveTab('inventory')}
          className={`flex items-center space-x-4 p-4 border rounded-lg shadow-md cursor-pointer ${activeTab === 'inventory' ? 'border-orange-500' : 'hover:border-orange-500'}`}>
          <FaBox className="text-2xl text-red-500" />
          <span className="text-lg font-bold">Product Inventory</span>
        </div>
        <div
          onClick={() => setActiveTab('visuals')}
          className={`flex items-center space-x-4 p-4 border rounded-lg shadow-md cursor-pointer ${activeTab === 'visuals' ? 'border-orange-500' : 'hover:border-orange-500'}`}>
          <FaImage className="text-2xl text-green-500" />
          <span className="text-lg font-bold">Visuals and Descriptions</span>
        </div>
        <div
          onClick={() => setActiveTab('animation')}
          className={`flex items-center space-x-4 p-4 border rounded-lg shadow-md cursor-pointer ${activeTab === 'animation' ? 'border-orange-500' : 'hover:border-orange-500'}`}>
          <FaFilm className="text-2xl text-blue-500" />
          <span className="text-lg font-bold">Animation and Content</span>
        </div>
        <div
          onClick={() => setActiveTab('cart')}
          className={`flex items-center space-x-4 p-4 border rounded-lg shadow-md cursor-pointer ${activeTab === 'cart' ? 'border-orange-500' : 'hover:border-orange-500'}`}>
          <FaShoppingCart className="text-2xl text-yellow-500" />
          <span className="text-lg font-bold">Shopping Cart</span>
        </div>
        <div
          onClick={() => setActiveTab('search')}
          className={`flex items-center space-x-4 p-4 border rounded-lg shadow-md cursor-pointer ${activeTab === 'search' ? 'border-orange-500' : 'hover:border-orange-500'}`}>
