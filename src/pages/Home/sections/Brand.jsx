    ...
    <section className="px-4 py-24 text-white bg-white md:px-8">
      <div className="container mx-auto text-center">
        ...
        <h1 className="mb-6 text-3xl font-bold text-black md:text-6xl">
          Increase Your Brand Visibility with Presence on Every Phone <span style={{color:"#ffa200"}}>App Screen</span> 
        </h1>

        {/* Description Paragraph */}
        <p className="mb-6 text-lg font-light leading-relaxed text-black md:text-xl">
          At <span className='font-bold' style={{color:"#ffa200"}}>AKCLinkTech </span>, we develop a personalized platform for your business 
