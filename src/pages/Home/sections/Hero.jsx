  ...
  return (
    <section className="relative flex items-center justify-center w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 px-4 text-center text-white">
        ...
        <button className="px-8 py-3 text-black hover:text-white transition duration-300 ease-in-out bg-orange-400 rounded-full hover:bg-transparent hover:border hover:border-2 hover:border-orange-700">
          Get Started
        </button>
      </div>
