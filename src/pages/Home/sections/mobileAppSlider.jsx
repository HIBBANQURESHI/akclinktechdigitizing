...
const appData = [
  { id: 1, name: 'Doctor', description: 'App Development Tailored for Doctors.', image: app1 },
  { id: 2, name: 'Restaurants', description: 'Designing seamless, smart apps for the food service industry', image: app2 },
  { id: 3, name: 'Ecommerce', description: 'Turning Concepts into Unforgettable Shopping Journeys.', image: app3 },
  { id: 4, name: 'Education', description: 'Elevate Education Through Seamless Tech Integration.', image: app4 },
