            ...
            <div className="flex-none mt-20 space-y-5 max-w-xl">
              ...
              <div className="flex items-center gap-x-3 sm:text-sm">
                <a
                  ...
                  className="flex items-center justify-center gap-x-1 py-4 px-5 text-black font-medium bg-yellow-500 duration-150 hover:bg-black hover:text-yellow-500 hover:border-2 hover:border-yellow-500 active:bg-gray-900 rounded-full md:inline-flex"
                >
                  Get started
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <a
                  href="/contact-us"
                  className="flex items-center justify-center gap-x-1 py-2 px-4 text-white hover:text-gray-400 font-medium duration-150 md:inline-flex"
                >
                  Contact sales
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
  ...
  <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
    <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
      <div className="text-gray-500 sm:text-lg dark:text-gray-400">
       ...
       <button className="bg-yellow-500 text-black hover:bg-white hover:text-yellow-500 hover:border-2 hover:border-yellow-500 font-semibold p-3 px-5 border rounded-xl">
        get a Free Quote
       </button>
      </div>
      <img
...
<p className="md:text-3xl flex justify-center mt-5 items-center row-span-1 font-bold text-black">Talk To Our Design Consultant For Free</p>
<div className="md:text-xl flex justify-center mt-5 items-center row-span-1 font-bold">
  <button className="btn bg-yellow-500 px-5 py-3 text-white mx-2 border rounded-xl hover:bg-white hover:text-black hover:border-2 hover:border-yellow-500">Live Chat</button>
  <button className="btn bg-white px-5 py-3 text-black mx-2 border border-yellow-500 rounded-xl hover:bg-yellow-100 hover:text-black">Get A Free Quote</button>
</div>
<p className="md:text-3xl flex justify-center mt-5  items-center row-span-1 font-bold text-black">or call us at <span className="mx-4 text-yellow-500"><FaPhoneAlt /></span> (832) 278-2818</p>
</section>
